      ...
      foreach ($resourceGroup in $resourceGroups){
        ...
        foreach ($resource in $resources) {
          ...
          $body = @{
            ...
            targetResourceGroup = "/subscriptions/$sourceSubscriptionID/resourceGroups/$targetresourceGroup"
          }
          ...
          if ($return) {
            ...
            if ($statusCode -eq 205) {
              ...
              if ($errorMesssage.message) {
                write-verbose "In If of `$errorMesssage.message.  $errorMessage is is still an object"
