function Create-AzTagReport {
  ...
  process {
    ...
    Function Get-AzTagReport {
      ...
      process {
        ...
        try {
          ...
          Write-Verbose "Error checking for tags on $resource"
          Write-Host "Error checking for tags on resource: $resource" -ForegroundColor Red
          Write-Host "Error Msg: $_" -ForegroundColor Red
        }
    ...
    foreach ($azSub in $selectedAzSubs) {
      ...
      $subscriptionTags = Get-AzTagReport
